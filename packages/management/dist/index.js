...
// --- PROMPTS ---
server.prompt('show_gateways_prompt', {}, () => ({
    messages: [
        {
            role: 'user',
            content: {
...
server.prompt('show_policies_prompt', {}, () => ({
    messages: [
        {
            role: 'user',
            content: {
...
server.prompt('show_rule_prompt', {
...
//   })
// );
server.prompt('source_to_destination_prompt', {
...
// --- TOOLS ---
server.tool('show_access_rulebase', 'Show the access rulebase for a given name or uid. Either name or uid is required, the other can be empty.', {
...
server.tool('show_hosts', 'Show the hosts in the management server.', {
...
server.tool('show_access_rule', 'Show a specific rule in the access control layer.', {
    layer: z.string(),
...
server.tool('show_access_layer', 'Show an access layer object by name or UID.', {
    name: z.string().optional().default(''),
    uid: z.string().optional().default(''),
    details_level: z.string().optional(),
}, async (args, extra) => {
...
server.tool('show_access_layers', 'Show all access layers, with optional filtering and detail level.', {
    ...
    const details_level = typeof args.details_level === 'string' ? args.details_level : undefined;
    const domains_to_process = Array.isArray(args.domains_to_process) ? args.domains_to_process : undefined;
...
server.tool('show_nat_rulebase', 'Show the NAT rulebase for a given name or uid. Either name or uid is required, the other can be empty.', {
    name: z.string().optional().default(''),
    uid: z.string().optional().default(''),
    package: z.string().optional(),
    filter: z.string().optional().default(''),
...
server.tool('show_access_section', 'Show an access section by name or UID and layer.', {
    name: z.string().optional().default(''),
    uid: z.string().optional().default(''),
...
server.tool('show_nat_section', 'Show a NAT section by name or UID and layer.', {
    name: z.string().optional().default(''),
    uid: z.string().optional().default(''),
    layer: z.string().optional().default(''),
    package: z.string().optional(),
...
server.tool('show_vpn_community_star', 'Show a VPN Community Star object by name or UID.', {
    name: z.string().optional().default(''),
    uid: z.string().optional().default(''),
    details_level: z.string().optional(),
}, async (args, extra) => {
...
server.tool('show_vpn_communities_star', 'Show all VPN Community Star objects, with optional filtering and detail level.', {
    filter: z.string().optional().default(''),
    limit: z.number().optional(),
    offset: z.number().optional(),
    order: z.array(z.string()).optional(),
...
server.tool('show_vpn_community_meshed', 'Show a VPN Community Meshed object by name or UID.', {
    name: z.string().optional().default(''),
    uid: z.string().optional().default(''),
    details_level: z.string().optional(),
}, async (args, extra) => {
...
server.tool('show_vpn_communities_meshed', 'Show all VPN Community Meshed objects, with optional filtering and detail level.', {
    filter: z.string().optional().default(''),
    limit: z.number().optional(),
    offset: z.number().optional(),
    order: z.array(z.string()).optional(),
...
server.tool('show_vpn_community_remote_access', 'Show a VPN Community Remote Access object by UID (or default if not specified).', {
    uid: z.string().optional().default(''),
    details_level: z.string().optional(),
}, async (args, extra) => {
    const uid = typeof args.uid === 'string' ? args.uid : '';
...
server.tool('show_vpn_communities_remote_access', 'Show all VPN Community Remote Access objects, with optional filtering and detail level.', {
    filter: z.string().optional().default(''),
    limit: z.number().optional(),
    offset: z.number().optional(),
    order: z.array(z.string()).optional(),
...
server.tool('show_gateways_and_servers', 'Retrieve multiple gateway and server objects with optional filtering and pagination.', {
    filter: z.string().optional().default(''),
    limit: z.number().optional().default(50),
    offset: z.number().optional().default(0),
    order: z.array(z.string()).optional(),
...
server.tool('show_simple_gateway', 'Retrieve a simple gateway object by name or UID.', {
    name: z.string().optional().default(''),
    uid: z.string().optional().default(''),
    details_level: z.string().optional(),
}, async (args, extra) => {
...
server.tool('show_simple_gateways', 'Retrieve multiple simple gateway objects with optional filtering and pagination.', {
    filter: z.string().optional().default(''),
    limit: z.number().optional().default(50),
    offset: z.number().optional().default(0),
...
server.tool('show_lsm_clusters', 'Retrieve multiple LSM cluster objects with optional filtering and pagination.', {
    filter: z.string().optional().default(''),
    limit: z.number().optional().default(50),
    offset: z.number().optional().default(0),
    order: z.array(z.any()).optional(),
...
server.tool('show_cluster_member', 'Retrieve a cluster member object by name or UID.', {
    name: z.string().optional().default(''),
    uid: z.string().optional().default(''),
    details_level: z.string().optional(),
}, async (args, extra) => {
...
server.tool('show_cluster_members', 'Retrieve multiple cluster member objects with optional filtering and pagination.', {
    filter: z.string().optional().default(''),
    limit: z.number().optional().default(50),
    offset: z.number().optional().default(0),
    order: z.array(z.any()).optional(),
...
server.tool('show_lsm_gateway', 'Retrieve an LSM gateway object by name or UID.', {
    name: z.string().optional().default(''),
    uid: z.string().optional().default(''),
    details_level: z.string().optional(),
}, async (args, extra) => {
...
server.tool('show_simple_clusters', 'Retrieve multiple simple cluster objects with optional filtering and pagination.', {
    filter: z.string().optional().default(''),
    limit: z.number().optional().default(50),
    offset: z.number().optional().default(0),
    order: z.array(z.any()).optional(),
...
server.tool('show_simple_cluster', 'Retrieve a simple cluster object by name or UID.', {
    name: z.string().optional().default(''),
    uid: z.string().optional().default(''),
    details_level: z.string().optional(),
}, async (args, extra) => {
...
server.tool('show_lsm_gateways', 'Retrieve multiple LSM gateway objects with optional filtering and pagination.', {
    filter: z.string().optional().default(''),
    limit: z.number().optional().default(50),
    offset: z.number().optional().default(0),
    order: z.array(z.any()).optional(),
...
server.tool('show_lsm_cluster', 'Retrieve an LSM cluster object by name or UID.', {
    name: z.string().optional().default(''),
    uid: z.string().optional().default(''),
    details_level: z.string().optional(),
}, async (args, extra) => {
...
server.tool('show_groups', 'Retrieve multiple group objects with optional filtering and pagination.', {
...
server.tool('show_services_tcp', 'Retrieve multiple TCP service objects with optional filtering and pagination.', {
    filter: z.string().optional(),
    limit: z.number().optional().default(50),
    offset: z.number().optional().default(0),
    order: z.array(z.any()).optional(),
...
server.tool('show_application_sites', 'Retrieve multiple application site objects with optional filtering and pagination.', {
    filter: z.string().optional(),
    limit: z.number().optional().default(50),
    offset: z.number().optional().default(0),
    order: z.array(z.any()).optional(),
...
server.tool('show_application_site_groups', 'Retrieve multiple application site group objects with optional filtering and pagination.', {
    filter: z.string().optional(),
    limit: z.number().optional().default(50),
    offset: z.number().optional().default(0),
    order: z.array(z.any()).optional(),
...
server.tool('show_services_udp', 'Retrieve multiple UDP service objects with optional filtering and pagination.', {
    filter: z.string().optional(),
    limit: z.number().optional().default(50),
    offset: z.number().optional().default(0),
    order: z.array(z.any()).optional(),
...
server.tool('show_wildcards', 'Retrieve multiple wildcard objects with optional filtering and pagination.', {
    filter: z.string().optional(),
    limit: z.number().optional().default(50),
    offset: z.number().optional().default(0),
    order: z.array(z.any()).optional(),
...
server.tool('show_security_zones', 'Retrieve multiple security zone objects with optional filtering and pagination.', {
    filter: z.string().optional(),
    limit: z.number().optional().default(50),
    offset: z.number().optional().default(0),
    order: z.array(z.any()).optional(),
...
// Tool: show_tags
server.tool('show_tags', 'Retrieve multiple tag objects with optional filtering and pagination.', {
    filter: z.string().optional(),
    limit: z.number().optional().default(50),
    offset: z.number().optional().default(0),
    order: z.array(z.any()).optional(),
...
server.tool('show_address_ranges', 'Retrieve multiple address range objects with optional filtering and pagination.', {
    filter: z.string().optional(),
    limit: z.number().optional().default(50),
    offset: z.number().optional().default(0),
    order: z.array(z.any()).optional(),
...
server.tool('show_application_site_categories', 'Retrieve multiple application site category objects with optional filtering and pagination.', {
    filter: z.string().optional(),
    limit: z.number().optional().default(50),
    offset: z.number().optional().default(0),
    order: z.array(z.any()).optional(),
...
server.tool('show_dynamic_objects', 'Retrieve multiple dynamic objects with optional filtering and pagination.', {
    filter: z.string().optional(),
    limit: z.number().optional().default(50),
    offset: z.number().optional().default(0),
    order: z.array(z.any()).optional(),
...
server.tool('show_services_icmp6', 'Retrieve multiple ICMPv6 service objects with optional filtering and pagination.', {
    filter: z.string().optional(),
    limit: z.number().optional().default(50),
    offset: z.number().optional().default(0),
    order: z.array(z.any()).optional(),
...
server.tool('show_services_icmp', 'Retrieve multiple ICMP service objects with optional filtering and pagination.', {
    filter: z.string().optional(),
    limit: z.number().optional().default(50),
    offset: z.number().optional().default(0),
    order: z.array(z.any()).optional(),
...
server.tool('show_service_groups', 'Retrieve multiple service group objects with optional filtering and pagination.', {
    filter: z.string().optional(),
    limit: z.number().optional().default(50),
    offset: z.number().optional().default(0),
    order: z.array(z.any()).optional(),
...
server.tool('show_multicast_address_ranges', 'Retrieve multiple multicast address range objects with optional filtering and pagination.', {
    filter: z.string().optional(),
    limit: z.number().optional().default(50),
    offset: z.number().optional().default(0),
    order: z.array(z.any()).optional(),
...
server.tool('show_dns_domains', 'Retrieve multiple DNS domain objects with optional filtering and pagination.', {
    filter: z.string().optional(),
    limit: z.number().optional().default(50),
    offset: z.number().optional().default(0),
    order: z.array(z.any()).optional(),
...
server.tool('show_time_groups', 'Retrieve multiple time group objects with optional filtering and pagination.', {
    filter: z.string().optional(),
    limit: z.number().optional().default(50),
    offset: z.number().optional().default(0),
    order: z.array(z.any()).optional(),
...
server.tool('show_access_point_names', 'Retrieve multiple access point name objects with optional filtering and pagination.', {
    filter: z.string().optional(),
    limit: z.number().optional().default(50),
    offset: z.number().optional().default(0),
    order: z.array(z.any()).optional(),
...
server.tool('show_objects', 'Retrieve multiple generic objects with optional filtering and pagination.', {
    filter: z.string().optional(),
    limit: z.number().optional().default(50),
    offset: z.number().optional().default(0),
    order: z.array(z.any()).optional(),
...
// Tool: show_object
server.tool('show_object', 'Retrieve a generic object by name or UID.', {
...
server.tool("show_time_objects", "Show all time objects", {}, async () => {
